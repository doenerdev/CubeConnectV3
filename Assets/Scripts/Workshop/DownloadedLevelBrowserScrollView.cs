...
public class DownloadedLevelBrowserScrollView : MonoBehaviour
{
    ...
    private DownloadedLevelBrowserPageSelection _levelBrowserPageSelection;
    private bool _initialized;

    [SerializeField]
    private Transform _scrollViewCenter;
    [SerializeField]
    ...
    public void Initialize(DownloadedLevelBrowserPageSelection levelBrowserPageSelection) //TODO anpassen
    {
    ...
    public void AddPage(DownloadedLevelBrowserLevelSelection page)
    {

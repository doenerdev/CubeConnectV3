...
public class WorkshopPlayLevelBrowserScrollView : MonoBehaviour {
    ...
    private WorkshopPlayLevelBrowserPageSelection _levelBrowserPageSelection;
    ...
    public void Initialize(WorkshopPlayLevelBrowserPageSelection levelBrowserPageSelection) //TODO anpassen
    {
    ...
    public void AddPage(WorkshopPlayLevelBrowserLevelSelection page)
    {

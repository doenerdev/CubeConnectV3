...
public class LevelEditorLevelBrowserScrollView : MonoBehaviour {
    ...
    private LevelEditorLevelBrowserPageSelection _levelBrowserPageSelection;
    ...
    public void Initialize(LevelEditorLevelBrowserPageSelection levelBrowserPageSelection) //TODO anpassen
    {
    ...
    public void AddPage(LevelEditorLevelBrowserLevelSelection page)
    {

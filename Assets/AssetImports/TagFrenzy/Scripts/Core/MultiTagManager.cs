...
namespace TagFrenzy
{
    ...
    public class MultiTagManager
    {
        ...
        private static string tagXmlFileName
        {
            get
            {
                return Path.Combine(Application.dataPath + "/AssetImports/", string.Format(@"TagFrenzy{0}Resources{0}Tags.xml", separator));
            }
        }
        ...
        private static string tagClassName
        {
            get
            {
                return Path.Combine(Application.dataPath + "/AssetImports/", string.Format(@"TagFrenzy{0}Scripts{0}Core{0}Tags.cs", separator));
            }
        }
